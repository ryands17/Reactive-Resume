...
description: "Configure an OpenAI, Anthropic, OpenRouter, or Ollama provider to power resume analysis, AI edits, agent drafts, and PDF imports."
---
...
| **Provider** | The provider type, such as OpenAI, Anthropic Claude, Vercel AI Gateway, OpenRouter, Ollama, or OpenAI-compatible. |
